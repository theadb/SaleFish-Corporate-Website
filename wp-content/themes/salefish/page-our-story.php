...
<main class="our_story">
		...
		<div class="wrapper">
			<div class="wrap">
				...
				<h1 data-aos="fade-up" data-aos-delay="100">The Best Way <br />
					...
					Period.</h1>
				<a class="button" data-aos="fade-up" data-aos-delay="300" target="_blank" rel="noopener noreferrer" href="https://meetings.hubspot.com/cindy-lloyd?uuid=f03a4178-d44c-48de-9a97-6795425bd38c" data-sf-section="Our Story — Hero">Make every sale a mic drop moment</a>
			</div>
		</div>
	</section>
	<!-- END HERO -->
	...
	<section class="platform">
		<div class="platform__wrap">
			...
			<div class="platform__showcase" data-aos="zoom-in">
				...
				<a class="button" target="_blank" rel="noopener noreferrer" href="https://meetings.hubspot.com/cindy-lloyd?uuid=f03a4178-d44c-48de-9a97-6795425bd38c" data-sf-section="Our Story — Platform Showcase">Book a Free Demo</a>
			</div>
			...
			<div class="security__split">
				...
				<div class="security__badge" data-aos="fade-left">
					<a href="https://ised-isde.canada.ca/site/cybersecure-canada/en" target="_blank" rel="noopener noreferrer">
						<img src="https://salefish.app/wp-content/uploads/2024/09/Group-1427.jpg" alt="CyberSecure Canada Certification" loading="lazy">
					</a>
				</div>
			</div>
		</div>
	...
	<section class="contact">
		...
		<div class="top">
			...
			<a class="button" target="_blank" rel="noopener noreferrer" href="https://meetings.hubspot.com/cindy-lloyd?uuid=f03a4178-d44c-48de-9a97-6795425bd38c" data-sf-section="Our Story — Contact CTA">Book a Free Demo</a>
		</div>
