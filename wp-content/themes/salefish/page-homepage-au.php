...
<main class="home">
		...
		<div class="wrapper">
			<div class="max_wrapper">
				<div class="left" data-aos="fade-right" data-aos-delay="300">
					...
					<a class="button" href="#contact_us">BOOK A FREE DEMO</a>
				</div>
	...
	<section class="contact">
		...
		<div class="top">
			...
			<a class="button" target="_blank" rel="noopener noreferrer" href="https://chatting.page/salefish">CHAT WITH US</a>
		</div>
		<!-- PILLARS -->
