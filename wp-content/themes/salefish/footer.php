...
?>
				<p>
					Made with <i data-lucide="heart" class="heart" width="13" height="13"></i> in Toronto, Calgary &amp; Vancouver. &copy; 2025 SaleFish Inc. All rights reserved. &nbsp;&middot;&nbsp; <a href="/terms-of-use"><?php echo esc_html( $_sf_terms ); ?></a> &nbsp;&middot;&nbsp; <a href="/privacy-policy"><?php echo esc_html( $_sf_privacy ); ?></a>
				</p>
			</div>
		</div>
	</div>
